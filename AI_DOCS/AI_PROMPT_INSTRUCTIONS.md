...
#     - Категория должна соответствовать category из registry
#     - Название должно быть ТОЧНЫМ как в tourData
#     - Ссылка категории должна быть правильной (/tours?category=X)
```
...
✅ PhangNgaSkywalk.tsx (готов, с видео интеграцией)
✅ CheoLanLake.tsx (СОЗДАН 11.10.2025 - нужны реальные фото!)
