...
> Важно: Это исторический отчёт о первой волне миграции на дату 12.10.2025. Числа внутри отражают состояние того периода. На текущий момент активных туров: 22, все они используют TourPageTemplate.
