...
- Одно изменение → 30+ туров обновлено
...
**[AI_PROMPT_INSTRUCTIONS.md](./AI_PROMPT_INSTRUCTIONS.md)** - 4186 строк
- Полная архитектура проекта
- Защищенные файлы
- Бизнес-логика
- CEO-мышление с 25% долей

### 2. Оптимизированный промт
**[AI_PROMPT_OPTIMIZED.md](./AI_PROMPT_OPTIMIZED.md)** - 1328 строк
