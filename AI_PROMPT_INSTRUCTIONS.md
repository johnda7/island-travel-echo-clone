...
### 🚨 ОСНОВНОЙ ЭТАЛОН: PhiPhi2Days1Night.tsx 
**ВСЕ НОВЫЕ ТУРЫ СОЗДАВАТЬ ТОЛЬКО ПО ЭТОМУ ОБРАЗЦУ!**

### 📋 СТРУКТУРА ЭТАЛОНА PhiPhi:
```typescript
// src/pages/PhiPhi2Days1Night.tsx - МАСТЕР-ШАБЛОН!
- Hero секция с главным фото
- Галерея с Navigation табами
- Описание тура  
- Карточка бронирования справа
- Программа по дням (itinerary)
...
4. **ДОБАВИТЬ маршрут** в App.tsx как у PhiPhi
5. **ДОБАВИТЬ в toursRegistry** ссылку на страницу
