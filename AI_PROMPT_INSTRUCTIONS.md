...
### ⚠️ **ЖЕСТКИЙ КОНТРОЛЬ ПО 22 ПУНКТАМ - ПРОВЕРЯЙ КАЖДОЕ ИЗМЕНЕНИЕ!**

**🔴 НИКОГДА не делай изменения без полной проверки всех 22 пунктов:**
...
npm run dev
# Открой страницу и пройдись по всем 22 пунктам
