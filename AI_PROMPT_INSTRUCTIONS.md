...
2. ✅ **ПОНЯТЬ АРХИТЕКТУРУ** WordPress-системы  
...
- **WordPress-архитектура**: добавил в одном месте = появилось везде
- **Централизация всего**: туры, данные, компоненты, стили
- **Защита рабочего кода**: что работает - НЕ ТРОГАТЬ!
- **Единые шаблоны**: один дизайн для всех туров
- **Автоматическая интеграция**: меню, поиск, категории
...
- src/App.tsx                     ← роуты приложения
- src/components/Tours.tsx        ← карточки туров
- src/components/BookingModal.tsx ← модальные окна
