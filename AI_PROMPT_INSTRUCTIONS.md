...
4. **Создавать универсальные шаблоны** - только индивидуальные страницы
5. **Менять структуру папок** - все на своих местах
...
1. **phi-phi-2days** - Пхи-Пхи 2 дня/1 ночь (priority: 1, ЭТАЛОН)
2. **pearls-andaman-sea** - 4 жемчужины Андаманского моря (priority: 2)
...
- `/excursion/four-pearls-andaman` → PearlsAndamanSea.tsx  
