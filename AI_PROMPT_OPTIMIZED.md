...
// 📋 18 КРИТЕРИЕВ ПРОВЕРКИ для всех туров:
...
18. 📱 Telegram кнопки "Написать в Телеграм"
...
```typescript
// 🎯 ПЛАН: Проверить каждый тур по 18 критериям
...
2. **✅ ГОТОВО: 18 критериев стандартизации** - полная система проверки
...
6. **✅ ГОТОВО: Система бронирования** - быстрые заказы через Telegram
...
1. **🎯 Адаптировать все туры** - привести к 18 критериям
