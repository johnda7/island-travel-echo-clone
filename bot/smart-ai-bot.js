...
const TOURS_DB = {
  ...
  'rafting-atv-zipline': {
    name: '🚣 Рафтинг + ATV + Zipline',
    slug: 'rafting-atv-zipline',
    price: 'от 2000 бат',
    duration: '1 день',
    description: 'Сплав 5км + квадроциклы + зиплайн + водопад',
    ...
    'https://www.phukeo.com/assets/maya-bay-1.jpg',
    {
      ...
      reply_markup: {
        inline_keyboard: [
          ...
          [{ text: '🏖️ Рача+Корал — 1300฿', callback_data: 'select_racha-coral-islands-speedboat' }],
    ...
    'https://www.phukeo.com/assets/phi-phi-speedboat-C_0fI01G.jpg',
    {
      ...
      reply_markup: {
        inline_keyboard: [
          ...
          [{ text: '🌅 Пхи-Пхи рассвет — 3800฿', callback_data: 'select_phi-phi-sunrise' }],
          [{ text: '🐠 Симиланы — 2500฿', callback_data: 'select_similan-islands' }],
          ...
          [{ text: '🏝️ Джеймс Бонд — 2000฿', callback_data: 'select_james-bond-island-phang-nga' }],
          [{ text: '🌟 11 островов МЕГА — 4200฿', callback_data: 'select_eleven-islands-mega' }],
          [{ text: '🏖️ Рача + Корал — 1300฿', callback_data: 'select_racha-coral-islands-speedboat' }],
          [{ text: '💎 4 Жемчужины — 4900฿', callback_data: 'select_pearls-andaman-sea' }],
          [{ text: '💎 5 Жемчужин Deluxe — 5500฿', callback_data: 'select_five-pearls-2days' }],
          [{ text: '⬅️ Назад', callback_data: 'back_to_menu' }]
        ]
      }
    }
    ...
    '🚣 *ПРИКЛЮЧЕНИЯ*\n\nВыберите тур:',
    {
      ...
      reply_markup: {
        inline_keyboard: [
          ...
          [{ text: '🐘 Као Лак Сафари — 3800฿', callback_data: 'select_kao-lak-safari-1-day' }],
          [{ text: '🏝️ Джеймс Бонд — 2000฿', callback_data: 'select_james-bond-island-phang-nga' }],
          [{ text: '🎣 Рыбалка на рассвете — 4400฿', callback_data: 'select_fishing-sunrise' }],
          [{ text: '⬅️ Назад', callback_data: 'back_to_menu' }]
        ]
      }
    }
...
🏝️ МНОГОДНЕВНЫЕ ТУРЫ:
• Пхи-Пхи 2 дня/1 ночь (4400฿) - Maya Bay, ночь на острове, закаты
• 4 Жемчужины Андаманского моря (7900฿) - Джеймс Бонд + Пхи-Пхи + Краби + Раяли
• 5 Жемчужин Deluxe (5500฿) - Премиум: Пхи-Пхи + Изумрудное озеро + делюкс отель

🌊 МОРСКИЕ ОСТРОВА:
• Пхи-Пхи (2500฿) - Maya Bay, снорклинг, классика
• Пхи-Пхи на рассвете Comfort+ (3800฿) - без толп, ранний выезд
• Симиланы Standard (2500฿) - лучший снорклинг в Таиланде
• Симиланы Early Bird (4200฿) - ранний выезд, меньше людей
• Симиланы Speedboat (4800฿) - быстро и комфортно
• Джеймс Бонд (2000฿) - залив Пханг Нга, каяки, пещеры
• 11 островов МЕГА-ТУР (4200฿) - Джеймс Бонд + Хонг + Пхи-Пхи за день!
• Рача + Корал спидбот (1300฿) - белый песок, парасейлинг
• Рача + Корал на рассвете (2800฿) - ранний выезд, чистая вода
• Рача + Корал с Rawai (2100฿) - удобно с юга Пхукета

🚣 ПРИКЛЮЧЕНИЯ И АКТИВНОСТИ:
• Рафтинг + SPA + ATV (2000฿) - сплав 5км + слоны + квадроциклы
• Рафтинг + SPA (2400฿) - сплав + слоны + водопад
• Као Лак Сафари (3800฿) - слоны, джунгли, водопады
• Рыбалка на рассвете (4400฿) - троллинг, подводная охота

🏞️ ПРИРОДА И КУЛЬТУРА:
• Чео Лан + Самет Нангше (2000฿) - озеро как в Китае, смотровая
...
- "море", "острова", "пляж", "снорклинг" → Пхи-Пхи (2500฿), Симиланы (2500฿), Рача+Корал (1300฿)
- "приключения", "активный", "экстрим" → Рафтинг+ATV (2000฿), Као Лак Сафари (3800฿)
- "природа", "озеро", "храм" → Чео Лан (2000฿), Краби (3100฿), Достопримечательности (1800฿)
- "дешево", "бюджет" → Достопримечательности (1800฿), Рача с Rawai (2100฿)
- "премиум", "люкс" → 5 Жемчужин Deluxe (5500฿), Пхи-Пхи 2 дня (4400฿)
...
// 🗺️ Каталог - открывает Mini App внутри Telegram
