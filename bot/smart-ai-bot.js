...
const TOURS_DB = {
  ...
  // === НОВЫЕ ТУРЫ (2026-02-27) ===
  'phi-phi-racha-maiton-sunset': {
    name: '🏝️ Пхи-Пхи + Рача Яй + закатная вечеринка у Майтон',
    slug: 'phi-phi-racha-maiton-sunset',
    price: 'от 2800 бат',
    duration: '1 день',
    description: 'Comfort+: Рача Яй, Пхи-Пхи Дон, Майя Бэй, закат у Майтон',
    details: 'Включено: спидбот, завтрак, обед, снаряжение, трансфер'
  },

  'elephant-beach-samet-mantra-spa': {
    name: '🐘 Слоны, пляж Самет и Мантра Спа',
    slug: 'elephant-beach-samet-mantra-spa',
    price: 'от 3100 бат',
    duration: '1 день',
    description: 'Этический слоновий питомник, пляж Самет Нан Шей, Мантра Спа',
    details: 'Включено: трансфер, обед, купание со слонами, спа'
  },

  'coral-islands-rawai': {
    name: '🪸 Коралловые острова с пирса Раваи',
    slug: 'coral-islands-rawai',
    price: 'от 1300 бат',
    duration: 'Полдня (08:30–14:00)',
    description: 'Коралловый остров, снорклинг, Хин Дам Бэй, отправление с Раваи',
    details: 'Включено: лонгтейл, снаряжение, обед, страховка'
  },

  'diving-andaman': {
    name: '🤿 Дайвинг в Андаманском море',
    slug: 'diving-andaman',
    price: 'от 4100 бат (2 погружения)',
    duration: '1 день',
    description: 'Для новичков и сертифицированных, 2 погружения, коралловые рифы',
    details: 'Включено: оборудование, инструктор PADI, трансфер, обед'
  }
};
...
• Пхи-Пхи + Рача Яй + Майтон (2800฿) - Comfort+, закат у Майтон, Maya Bay ✨НОВЫЙ
...
• Коралловые острова с Раваи (1300฿) - полдня, лонгтейл, бюджетно ✨НОВЫЙ
...
• Слоны + пляж Самет + Мантра Спа (3100฿) - этический питомник, спа ✨НОВЫЙ
• Рыбалка на рассвете (4500฿) - троллинг, подводная охота

🤿 ДАЙВИНГ:
• Дайвинг в Андаманском море (4100฿ за 2 погружения) - для новичков и про ✨НОВЫЙ
...
- "море", "острова", "пляж", "снорклинг" → Пхи-Пхи (2500฿), Симиланы (3500฿), Коралловые с Раваи (1300฿)
...
- "дешево", "бюджет" → Коралловые с Раваи (1300฿), Достопримечательности (1800฿), Рача с Rawai (2100฿)
- "премиум", "люкс" → 5 Жемчужин Deluxe (9900฿), Пхи-Пхи 2 дня (4500฿)
- "семья", "дети" → Рача+Корал (спокойно), Достопримечательности, Пхи-Пхи
- "слоны", "спа" → Слоны + Самет + Мантра Спа (3100฿)
- "дайвинг", "погружение" → Дайвинг в Андаманском море (4100฿)
- "закат", "вечеринка" → Пхи-Пхи + Рача + Майтон (2800฿)
