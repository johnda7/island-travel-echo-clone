...
// ❌ КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО: менять редирект window.location.href на t.me/Phuketga?text=
// ❌ КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО: заменять window.location.href на clipboard, openTelegramLink, openLink, tg://resolve или ЛЮБОЙ другой метод
// ❌ КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО: добавлять isTelegramMiniApp проверки для редиректа
// ⚠️ РАБОЧИЙ МЕТОД РЕДИРЕКТА: window.location.href = `https://t.me/Phuketga?text=${encodeURIComponent(message)}`
// ⚠️ ЭТО ЕДИНСТВЕННЫЙ РАБОТАЮЩИЙ МЕТОД! ПРОВЕРЕНО 27.02.2026! НЕ ТРОГАТЬ!
