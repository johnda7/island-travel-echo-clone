...
export const phiPhi2DaysTourData: TourData = {
  ...
  description: `Эксклюзивное двухдневное путешествие на легендарные острова Пхи-Пхи с ночёвкой в отеле на острове.

<strong>Первый день:</strong> Знакомство с самыми красивыми местами архипелага — бухта Майя Бэй из фильма «Пляж», лагуна Пиле с изумрудной водой, пещера викингов с древними наскальными рисунками.

<strong>Вечерняя программа:</strong> Подъём на смотровую площадку для встречи заката, пляжная вечеринка с огненным шоу и живой музыкой.

<strong>Второй день:</strong> Снорклинг у Бамбукового острова, посещение пляжа обезьян, свободное время для отдыха на белоснежных пляжах.

<strong>Особенности тура:</strong>
• Проживание в комфортном отеле 3* на острове Пхи-Пхи Дон
• Небольшие группы до 30 человек для комфортного отдыха
• Русскоговорящий гид на протяжении всего путешествия
• Трёхразовое питание в первый день включено в стоимость
• Профессиональное снаряжение для снорклинга`,
  ...
  whatToBring: [
    ...
    "Купальник и запасная одежда",
    "Фотоаппарат или водонепроницаемый чехол для телефона",
  ...
  importantInfo: [
    ...
    "При проблемах с морской болезнью рекомендуем принять таблетку за час до отправления"
  ]
};