...
export const toursData: Tour[] = [
  ...
  },
  {
    ...
    group: "До 35 человек",
    dates: "Круглый год",
    price: "2,500 ฿ взр. / 2,000 ฿ дети",
    originalPrice: "2,800 ฿",
    rating: 4.9,
    reviews: 127,
    image: jamesBondIslandImages.main,
    highlights: [
      "Остров Ко Тапу - место съёмок фильма 007",
      "Каноэ по мангровым лесам и пещерам", 
      "Плавучая деревня мусульман Ко Паньи",
      "Обед из морепродуктов в плавучем ресторане"
    ],
    description: "Незабываемое путешествие к легендарному острову Джеймса Бонда (Ко Тапу) в заливе Пханг Нга - месту съёмок знаменитого фильма 'Человек с золотым пистолетом'.",
    featured: true,
    category: "marine",
