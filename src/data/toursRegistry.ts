...
export const TOURS_REGISTRY: TourRegistryItem[] = [
  ...
  // 🆕 НОВЫЕ 10 ТУРОВ (Октябрь 2025) - Tours 15-24
  {
    ...
    category: 'islands',
    tags: ['симиланы', 'острова', 'дайвинг', 'снорклинг', 'море', 'пляж', 'тропики', '1 день', 'андаманское море', 'национальный парк'],
    isPopular: true,
    isActive: true,
    isFeatured: true,
    priority: 15,
  ...
  
  {
    ...
    category: 'islands',
    tags: ['симиланы', 'острова', 'дайвинг', 'снорклинг', 'море', 'comfort+', 'ранний выезд', 'пляж', 'тропики', '1 день', 'премиум'],
    isPopular: true,
    isActive: true,
    isFeatured: false,
    priority: 16,
  ...
  
  {
    ...
    category: 'islands',
    tags: ['симиланы', 'острова', 'спидбот', 'быстро', 'снорклинг', 'море', '1 день'],
    isPopular: false,
    isActive: true,
    isFeatured: false,
    priority: 17,
  ...
  
  {
    ...
    category: 'fishing',
    tags: ['рыбалка', 'троллинг', 'подводная охота', 'море', 'рассвет', 'краби ловушки', 'активный отдых', '1 день'],
    isPopular: true,
    isActive: true,
    isFeatured: false,
    priority: 18,
  ...
  
  {
    ...
    category: 'islands',
    tags: ['рача', 'корал', 'рассвет', 'снорклинг', 'острова', 'море', 'comfort+', 'премиум', '1 день'],
    isPopular: true,
    isActive: true,
    isFeatured: true,
    priority: 19,
  ...
  
  {
    ...
    category: 'islands',
    tags: ['рача', 'корал', 'rawai', 'раваи', 'снорклинг', 'острова', 'море', '1 день', 'удобный выезд'],
    isPopular: true,
    isActive: true,
    isFeatured: false,
    priority: 20,
  ...
  
  {
    ...
    category: 'islands',
    tags: ['пхи-пхи', 'майя бэй', 'рассвет', 'острова', 'море', 'comfort+', 'премиум', 'снорклинг', '1 день', 'леонардо ди каприо'],
    isPopular: true,
    isActive: true,
    isFeatured: true,
    priority: 21,
  ...
  
  {
    ...
    category: 'islands',
    tags: ['пхи-пхи', 'краби', 'раяли', '2 дня', 'ночевка', 'делюкс', 'премиум', 'острова', 'море', 'изумрудное озеро', 'горячие источники', 'майя бэй'],
    isPopular: true,
    isActive: true,
    isFeatured: true,
    priority: 22,
  ...
  
  {
    ...
    category: 'adventure',
    tags: ['пхангнга', 'самет нангше', 'смотровая', 'слоны', 'храм', 'пляж самолетов', 'природа', '1 день', 'сафари'],
    isPopular: true,
    isActive: true,
    isFeatured: true,
    priority: 23,
  ...
  
  {
    ...
    category: 'adventure',
    tags: ['краби', 'изумрудное озеро', 'храм тигра', 'голубое озеро', 'пещеры', 'водопад', 'природа', 'приключения', '1 день', 'активный отдых', 'слоны'],
    isPopular: true,
    isActive: true,
    isFeatured: true,
    priority: 24,
