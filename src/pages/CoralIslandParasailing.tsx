...
import { Clock, Users, MapPin, Star, Calendar, Wind, Camera } from "lucide-react";

const CoralIslandParasailing = () => {
  const excursion = {
    ...
    rating: 4.6,
    reviewsCount: 167,
    mainImage: "https://images.unsplash.com/photo-1559827260-dc66d52bef19?auto=format&fit=crop&w=1200&q=80",
    gallery: [
    ...
    description: "Откройте для себя Коралловый остров с его белоснежными пляжами и кристально чистой водой! Получите незабываемые эмоции от парасейлинга и насладитесь водными видами спорта.",
    highlights: [
      "Парасейлинг над морем",
      "Коралловый остров",
      "Белоснежные пляжи",
      "Водные виды спорта",
      "Снорклинг",
    ...
    schedule: [
      ...
      { time: "09:30", activity: "Отправление на лодке" },
      { time: "10:30", activity: "Прибытие на Коралловый остров" },
      { time: "11:00", activity: "Парасейлинг" },
      { time: "12:30", activity: "Обед на пляже" },
      { time: "14:00", activity: "Водные виды спорта" },
      { time: "15:30", activity: "Релакс на пляже" },
      ...
      <section className="pt-20 pb-8">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="mb-4">
                <span className="text-teal-600 font-medium">Морские экскурсии • Водные развлечения</span>
              </div>
            ...
            <div className="relative">
              ...
              <div className="absolute top-4 right-4 bg-teal-600 text-white px-3 py-2 rounded-lg flex items-center gap-2">
                ...
                <span className="font-semibold">Парасейлинг</span>
              </div>
            </div>
          </div>
        </div>
...
export default CoralIslandParasailing;
