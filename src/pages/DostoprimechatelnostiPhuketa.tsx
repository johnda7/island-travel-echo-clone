                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-4 mb-6">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-medium">{excursion.priceAdult} {excursion.currency}</span>
                      </div>

                      <div className="flex items-center justify-between">
                        <span className="text-gray-700">Дети (4-11 лет)</span>
                        <span className="font-medium">{excursion.priceChild} {excursion.currency}</span>
                      </div>

                      <div className="pt-4 border-t">
                        <div className="flex justify-between text-lg font-semibold">
                          <span>Стартовая цена:</span>
                          <span className="text-green-600">{excursion.priceAdult} {excursion.currency}</span>
                        </div>
                      </div>
                    </div>
