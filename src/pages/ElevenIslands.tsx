...
import jamesBond1 from "@/assets/phi-phi-2days/maya-bay-1.jpg";
import jamesBond2 from "@/assets/phi-phi-2days/maya-bay-2.jpg";
...
import hong2 from "@/assets/phi-phi-2days/bamboo-island.webp";
import speedboat1 from "@/assets/phi-phi-speedboat.jpg";
import snorkeling1 from "@/assets/phi-phi-snorkeling.jpg";

const excursion = {
  title: "11 островов Мега-тур",
  subtitle: "Один эпичный день - Джеймс Бонд + остров Хонг + Пхи-Пхи",
  price: "от 3 900",
  currency: "฿", 
  ...
  description: `
11 ОСТРОВОВ - это уникальная возможность посетить три знаменитые локации за один день: остров Джеймса Бонда, остров Хонг и острова Пхи-Пхи. Эпичное путешествие на скоростном катере по самым красивым местам Андаманского моря.

Программа включает посещение пещер, снорклинг в кристально чистых водах, обед на пляже и множество фотовозможностей в самых инстаграмных локациях Таиланда.
`,
  highlights: [
    "Остров Джеймса Бонда (Ко Тапу)",
    "Пещера Джеймса Бонда и каноэ",
    "Остров Хонг - скрытая лагуна", 
    "Острова Пхи-Пхи - Майя Бэй",
    "Снорклинг на Бамбу айленд",
    "Скоростной катер - быстрые переходы",
    "11 уникальных локаций за день"
  ],
  included: [
    "Трансфер из отеля и обратно",
    "Русскоговорящий гид на весь день",
    "Завтрак, обед и легкие закуски",
    "Скоростной катер с комфортными сиденьями",
    "Входные билеты во все национальные парки",
    "Снаряжение для снорклинга и маски",
    "Каноэ в пещере Джеймса Бонда",
    "Спасательные жилеты",
  ...
  notIncluded: [
    ...
    "Подводная фото/видеосъемка",
    "Дополнительные услуги на островах"
  ],
  schedule: [
    { day: "Утро", time: "06:30-07:30", activity: "Сбор туристов из отелей" },
    { day: "Утро", time: "08:00", activity: "Завтрак на пирсе, знакомство с гидом" },
    { day: "Утро", time: "08:30", activity: "Отправление на остров Джеймса Бонда" },
    { day: "Утро", time: "09:30", activity: "Остров Джеймса Бонда (Ко Тапу), фотосессия" },
    { day: "Утро", time: "10:30", activity: "Каноэ в пещере Джеймса Бонда" },
    { day: "День", time: "11:30", activity: "Переезд на остров Хонг" },
    { day: "День", time: "12:30", activity: "Обед на пляже острова Хонг" },
    { day: "День", time: "13:30", activity: "Исследование скрытой лагуны острова Хонг" },
    { day: "День", time: "14:30", activity: "Переезд на острова Пхи-Пхи" },
    { day: "День", time: "15:30", activity: "Майя Бэй - знаменитый пляж из фильма 'Пляж'" },
    { day: "Вечер", time: "16:30", activity: "Снорклинг на Бамбу айленд" },
    { day: "Вечер", time: "17:30", activity: "Возвращение на Пхукет" },
    { day: "Вечер", time: "19:00", activity: "Прибытие в отель" }
  ],
  whatToBring: [
    "Купальник/плавки",
    "Полотенце",
  ...
  importantInfo: [
    "Тур не подходит беременным женщинам",
    "Дети до 4 лет бесплатно, 4-11 лет скидка 50%",
    "При морской болезни возьмите таблетки",
    "Майя Бэй может быть закрыта по решению властей",
    "При плохой погоде маршрут может изменяться",
    "Максимальный вес для каноэ - 130 кг",
    "Время в пути между локациями 30-60 минут"
  ]
};
        ...
        <div className="container mx-auto px-4">
          <nav className="text-sm text-gray-500">
            <div className="flex items-center space-x-2">
              ...
              <span>›</span>
              <span className="text-gray-700">11 островов Мега-тур</span>
            </div>
          </nav>
        </div>
      </section>
              ...
              <Card className="sticky top-24 border border-gray-200 shadow-lg">
                <CardContent className="p-6">
                  ...
                  <Button asChild className="w-full bg-green-600 hover:bg-green-700 text-white">
                    <Link to="/book/eleven-islands/reserv">Забронировать тур</Link>
                  </Button>
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 z-40">
        <div className="flex items-center justify-between gap-4">
          ...
          <Button asChild className="bg-green-600 hover:bg-green-700 text-white px-6">
            <Link to="/book/eleven-islands/reserv">Забронировать</Link>
          </Button>
        </div>
      </div>
