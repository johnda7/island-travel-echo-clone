...
import { elevenIslandsStandardTourData } from '@/data/elevenIslandsStandardTour';
import { UniversalBookingModal } from "@/components/UniversalBookingModal";
import { ModalPortal } from "@/components/ModalPortal";

// ИСПОЛЬЗУЕМ ЕДИНЫЙ ИСТОЧНИК ДАННЫХ
const excursion = elevenIslandsStandardTourData;

const ElevenIslandsStandardTour = () => {
        ...
        <div className="container mx-auto px-4">
          <nav className="text-sm text-gray-500">
            <div className="flex items-center space-x-2">
              ...
              <span>›</span>
              <span className="text-gray-700">11 островов Стандарт</span>
            </div>
          </nav>
        </div>
      </section>
...
export default ElevenIslandsStandardTour;