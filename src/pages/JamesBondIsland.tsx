...
import { Clock, Users, MapPin, Star, Calendar, Mountain, Camera } from "lucide-react";
...
const JamesBondIsland = () => {
  const excursion = {
    ...
    description: "Посетите знаменитый остров Джеймса Бонда (Ко Тапу) в заливе Пханг Нга! Увидите невероятные известняковые скалы, исследуете пещеры на каноэ и посетите плавучую деревню морских цыган.",
    highlights: [
      "Остров Ко Тапу (Джеймса Бонда)",
      "Залив Пханг Нга",
      "Пещеры и гроты",
      "Каноэ в мангровых зарослях",
      "Плавучая деревня",
      "Обед на острове",
      "Известняковые скалы",
      "Панорамные виды"
    ...
    schedule: [
      ...
      { time: "11:00", activity: "Остров Джеймса Бонда" },
      { time: "12:30", activity: "Каноэ в пещерах" },
      { time: "13:30", activity: "Обед на острове" },
      { time: "15:00", activity: "Плавучая деревня" },
      { time: "16:00", activity: "Исследование залива" },
      ...
      <section className="pt-20 pb-8">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="mb-4">
                <span className="text-teal-600 font-medium">Морские экскурсии • Национальный парк</span>
              </div>
            ...
            <div className="relative">
              ...
              <div className="absolute top-4 right-4 bg-teal-600 text-white px-3 py-2 rounded-lg flex items-center gap-2">
                ...
                <span className="font-semibold">Известняковые скалы</span>
              </div>
            </div>
          </div>
        </div>
