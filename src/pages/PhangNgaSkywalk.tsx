        ...
        <div className="container mx-auto px-4">
          <nav className="text-sm text-gray-500">
              <div className="flex items-center space-x-2">
                ...
                <span>›</span>
                <Link to="/tours?category=adventure" className="hover:text-green-600 transition-colors">Приключенческие туры</Link>
                <span>›</span>
                <span className="text-gray-700">Удивительная Пхангнга + Стеклянный мост</span>
              </div>
            </nav>
          </div>
        </section>
...
export default PhangNgaSkywalk;