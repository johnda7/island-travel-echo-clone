...
import { toursData as centralizedTours } from "@/data/tours";

// Используем централизованные данные туров из WordPress CMS-подобной системы
const toursData = centralizedTours;
  {
    id: 101,
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {filteredTours.map((tour) => (
            <Card key={tour.id} className="group overflow-hidden border-0 shadow-lg transition-all duration-500 transform hover:shadow-2xl hover:-translate-y-2">
