...
export const phiPhiTourData: TourData = {
  ...
  description: `Авторская программа, идеально подходящая для семей с детьми, беременных женщин и лиц пожилого возраста. Экскурсия также подойдёт для друзей и тех, кто хочет провести больше времени на Пхи-Пхи.
...
Это путешествие в небольшой группе по таинственным бухтам Пхи-Пхи сочетает блаженство и спокойствие с вечеринками и огненным шоу. Включает посещение смотровой площадки и встречу заката в море. Проживание в отеле на острове Пхи-Пхи Дон.`,
  ...
  mainImage: mayaBay1,
  highlights: [
    "Посещение знаменитой бухты Майя Бей из фильма 'Пляж'", 
    "Плавание в изумрудной лагуне Пиле",
    "Исследование пещеры Викингов с древними рисунками",
    "Релакс на белоснежных пляжах острова Бамбу",
    "Огненное шоу на пляже под звездным небом"
  ],
  gallery: [
    mayaBay1,
    mayaBay2,
  ...
  itinerary: [
    {
      day: "1",
      time: "08:00",
      activity: "Трансфер из отеля на пирс, отправление на скоростном катере"
    },
    {
      day: "1", 
      time: "10:00",
      activity: "Прибытие на главный остров, заселение в отель, обед"
    },
    {
      day: "1",
      time: "14:00", 
      activity: "Посещение знаменитой бухты из фильма 'Пляж', фотосессия"
    },
    {
      day: "1",
      time: "15:30",
      activity: "Плавание в изумрудной лагуне, снорклинг"
    },
    {
      day: "1",
      time: "20:00",
      activity: "Ужин и традиционное огненное шоу на пляже"
    },
    {
      day: "2",
      time: "09:00",
      activity: "Завтрак, посещение пещеры с древними рисунками"
    },
    {
      day: "2",
      time: "11:00", 
      activity: "Релакс на белоснежном пляже, снорклинг"
    },
    {
      day: "2",
      time: "15:00",
      activity: "Обед, отправление в Пхукет, трансфер в отель"
    }
  ],
